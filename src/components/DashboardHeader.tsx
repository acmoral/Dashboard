              ...
              <div className="relative">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button type="button" variant="outline" className="sm:text-xl md:text-xl lg:text-xl xxl:text-xl relative pl-3 pr-8 text-sm bg-input-background border-0">
                  ...
                  <DropdownMenuContent align="start" className="w-48 z-50">
                    <DropdownMenuCheckboxItem onClick={() => onAuthorFilterChange('all')} className={activeAuthors.length === availableAuthors.length ? "bg-gray-100 font-semibold text-primary" : "sm:text-xl md:text-xl lg:text-xl xxl:text-xl"}>Todos los autores</DropdownMenuCheckboxItem>
            ...
            <label className="sm:text-lg md:text-lg lg:text-lg xxl:text-lg text-muted-foreground whitespace-nowrap">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="sm:text-xl md:text-xl lg:text-xl xxl:text-xl pl-10  bg-input-background border-0"
                  value={activeTopics}
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="sm:text-lg md:text-lg lg:text-lg xxl:text-lg w-60 bg-input-background border-0"
                />
              </div>
            </div>
